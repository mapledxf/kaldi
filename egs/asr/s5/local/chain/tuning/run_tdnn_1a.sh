...
train_stage=-10
get_egs_stage=-10
dir=/home/data/xfding/asr-noisy-48h/output/exp/chain/tdnn_1a  # Note: _sp will get added to this
decode_iter=
...
train_set=train
test_sets="dev test"
ali_dir=/home/data/xfding/asr-noisy-48h/output/exp/tri3_ali
treedir=/home/data/xfding/asr-noisy-48h/output/exp/chain/tri4_cd_tree_sp
lang=/home/data/xfding/asr-noisy-48h/output/data/lang_chain

if [ $stage -le 6 ]; then
  mfccdir=mfcc_hires
  for datadir in ${train_set} ${test_sets}; do
  	utils/copy_data_dir.sh data/${datadir} /home/data/xfding/asr-noisy-48h/output/data/${datadir}_hires
	utils/data/perturb_data_dir_volume.sh /home/data/xfding/asr-noisy-48h/output/data/${datadir}_hires || exit 1;
	steps/make_mfcc.sh --mfcc-config conf/mfcc_hires.conf --nj $nj /home/data/xfding/asr-noisy-48h/output/data/${datadir}_hires /home/data/xfding/asr-noisy-48h/output/exp/make_mfcc/ ${mfccdir}
  done
fi
...
if [ $stage -le 7 ]; then
  ...
  steps/align_fmllr_lats.sh --nj $nj --cmd "$train_cmd" /home/data/xfding/asr-noisy-48h/output/data/$train_set \
    /home/data/xfding/asr-noisy-48h/output/data/lang /home/data/xfding/asr-noisy-48h/output/exp/tri3 exp/tri4_sp_lats
...
if [ $stage -le 8 ]; then
  ...
  rm -rf $lang
  cp -r /home/data/xfding/asr-noisy-48h/output/data/lang $lang
...
if [ $stage -le 9 ]; then
  ...
  steps/nnet3/chain/build_tree.sh --frame-subsampling-factor 3 \
      ...
      --cmd "$train_cmd" 5000 /home/data/xfding/asr-noisy-48h/output/data/$train_set $lang $ali_dir $treedir
fi
...
if [ $stage -le 11 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --feat-dir /home/data/xfding/asr-noisy-48h/output/data/${train_set}_hires \
    --tree-dir $treedir \
    --use-gpu wait \
    --lat-dir /home/data/xfding/asr-noisy-48h/output/exp/tri4_sp_lats \
    --dir $dir  || exit 1;
fi
...
if [ $stage -le 12 ]; then
  ...
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 /home/data/xfding/asr-noisy-48h/output/data/lang_test $dir $dir/graph
fi
...
if [ $stage -le 13 ]; then
  for test_set in $test_sets; do
    steps/nnet3/decode.sh --acwt 1.0 --post-decode-acwt 10.0 \
      ...
      $graph_dir /home/data/xfding/asr-noisy-48h/output/data/${test_set}_hires $dir/decode_${test_set} || exit 1;
  done
fi
