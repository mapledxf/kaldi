...
ali_dir=$out_dir/exp/${gmm}_ali_${train_set}_sp_comb
...
dir=$out_dir/exp/chain${nnet3_affix}/tdnn${affix}_sp
train_data_dir=$out_dir/data/${train_set}_sp_hires
lores_train_data_dir=$out_dir/data/${train_set}_sp
train_ivector_dir=$out_dir/exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires_comb
...
if [ $stage -le 11 ]; then
  ...
  steps/align_fmllr_lats.sh --nj 75 --cmd "$train_cmd" ${lores_train_data_dir} \
    $out_dir/data/lang $gmm_dir $lat_dir
